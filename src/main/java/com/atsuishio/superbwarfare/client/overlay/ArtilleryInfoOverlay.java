...
public class ArtilleryInfoOverlay implements IGuiOverlay {

    public static final String ID = Mod.MODID + "_artillery_info";
    ...
    public void render(ForgeGui gui, GuiGraphics guiGraphics, float partialTick, int screenWidth, int screenHeight) {
        ...
        if (lookingEntity instanceof ArtilleryEntity artilleryEntity) {
            guiGraphics.drawString(Minecraft.getInstance().font, Component.translatable("tips.superbwarfare.mortar.pitch")
                            .append(Component.literal(FormatTool.format1D(-artilleryEntity.getXRot(), "°"))),
            ...
            guiGraphics.drawString(Minecraft.getInstance().font, Component.translatable("tips.superbwarfare.mortar.yaw")
                            .append(Component.literal(FormatTool.format1D(artilleryEntity.getYRot(), "°"))),
            ...
            guiGraphics.drawString(Minecraft.getInstance().font, Component.translatable("tips.superbwarfare.mortar.range")
                            .append(Component.literal(FormatTool.format1D((int) RangeTool.getRange(-artilleryEntity.getXRot(), 11.4, 0.146), "m"))),
