...
import com.atsuishio.superbwarfare.client.model.entity.M1Model;
...
import static com.atsuishio.superbwarfare.entity.vehicle.M1Entity.YAW;

public class M1Renderer extends GeoEntityRenderer<M1Entity> {

    public M1Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new M1Model());
    }

    @Override
    public RenderType getRenderType(M1Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, M1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(M1Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, M1Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
