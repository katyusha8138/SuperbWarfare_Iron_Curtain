...
import com.atsuishio.superbwarfare.client.model.entity.M46Model;
...
import static com.atsuishio.superbwarfare.entity.vehicle.M46Entity.YAW;

public class M46Renderer extends GeoEntityRenderer<M46Entity> {

    public M46Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new M46Model());
    }

    @Override
    public RenderType getRenderType(M46Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, M46Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(M46Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, M46Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
