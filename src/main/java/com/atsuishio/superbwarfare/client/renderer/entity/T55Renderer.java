...
import com.atsuishio.superbwarfare.client.model.entity.T55Model;
...
import static com.atsuishio.superbwarfare.entity.vehicle.T55Entity.YAW;

public class T55Renderer extends GeoEntityRenderer<T55Entity> {

    public T55Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new T55Model());
    }

    @Override
    public RenderType getRenderType(T55Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, T55Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(T55Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, T55Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
