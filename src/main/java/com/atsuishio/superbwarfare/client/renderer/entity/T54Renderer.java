...
import com.atsuishio.superbwarfare.client.model.entity.T54Model;
...
import static com.atsuishio.superbwarfare.entity.vehicle.T54Entity.YAW;

public class T54Renderer extends GeoEntityRenderer<T54Entity> {

    public T54Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new T54Model());
    }

    @Override
    public RenderType getRenderType(T54Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, T54Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(T54Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, T54Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
