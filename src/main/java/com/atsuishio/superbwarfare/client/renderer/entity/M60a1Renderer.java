...
import com.atsuishio.superbwarfare.client.model.entity.M60a1Model;
...
import static com.atsuishio.superbwarfare.entity.vehicle.M60a1Entity.YAW;

public class M60a1Renderer extends GeoEntityRenderer<M60a1Entity> {

    public M60a1Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new M60a1Model());
    }

    @Override
    public RenderType getRenderType(M60a1Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, M60a1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(M60a1Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, M60a1Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
