...
import com.atsuishio.superbwarfare.client.model.entity.T64Model;
...
import static com.atsuishio.superbwarfare.entity.vehicle.T64Entity.YAW;

public class T64Renderer extends GeoEntityRenderer<T64Entity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, T64Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(T64Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, T64Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
