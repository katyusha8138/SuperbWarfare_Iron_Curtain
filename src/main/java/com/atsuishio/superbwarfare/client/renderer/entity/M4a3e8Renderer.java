...
import com.atsuishio.superbwarfare.client.model.entity.M4a3e8Model;
...
import static com.atsuishio.superbwarfare.entity.vehicle.M4a3e8Entity.YAW;

public class M4a3e8Renderer extends GeoEntityRenderer<M4a3e8Entity> {

    public M4a3e8Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new M4a3e8Model());
    }

    @Override
    public RenderType getRenderType(M4a3e8Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, M4a3e8Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(M4a3e8Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, M4a3e8Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
