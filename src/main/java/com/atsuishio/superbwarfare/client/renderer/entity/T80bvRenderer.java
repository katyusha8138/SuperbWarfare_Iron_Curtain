...
import com.atsuishio.superbwarfare.client.model.entity.T80bvModel;
...
import static com.atsuishio.superbwarfare.entity.vehicle.T80bvEntity.YAW;

public class T80bvRenderer extends GeoEntityRenderer<T80bvEntity> {

    public T80bvRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new T80bvModel());
    }

    @Override
    public RenderType getRenderType(T80bvEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, T80bvEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(T80bvEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, T80bvEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
