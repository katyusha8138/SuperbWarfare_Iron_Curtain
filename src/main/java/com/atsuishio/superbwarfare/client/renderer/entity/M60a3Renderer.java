...
import com.atsuishio.superbwarfare.client.model.entity.M60a3Model;
import com.atsuishio.superbwarfare.entity.vehicle.M60a3Entity;
...
import static com.atsuishio.superbwarfare.entity.vehicle.M60a3Entity.YAW;

public class M60a3Renderer extends GeoEntityRenderer<M60a3Entity> {

    public M60a3Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new M60a3Model());
    }

    @Override
    public RenderType getRenderType(M60a3Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, M60a3Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(M60a3Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, M60a3Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        ...
        if (name.equals("machinegunbarrel")) {
            float a = animatable.getTurretYaw(partialTick);
            float r = (Mth.abs(a) - 90f) / 90f;
