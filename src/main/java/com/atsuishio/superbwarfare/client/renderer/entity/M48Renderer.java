...
import com.atsuishio.superbwarfare.client.model.entity.M48Model;
...
import static com.atsuishio.superbwarfare.entity.vehicle.M47Entity.YAW;

public class M48Renderer extends GeoEntityRenderer<M48Entity> {

    public M48Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new M48Model());
    }

    @Override
    public RenderType getRenderType(M48Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, M48Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(M48Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, M48Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
