...
import com.atsuishio.superbwarfare.client.model.entity.T62Model;
...
import static com.atsuishio.superbwarfare.entity.vehicle.T62Entity.YAW;

public class T62Renderer extends GeoEntityRenderer<T62Entity> {

    public T62Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new T62Model());
    }

    @Override
    public RenderType getRenderType(T62Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, T62Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(T62Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, T62Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
