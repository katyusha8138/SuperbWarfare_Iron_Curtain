...
import com.atsuishio.superbwarfare.client.model.entity.Btr80Model;
...
import static com.atsuishio.superbwarfare.entity.vehicle.Btr80Entity.YAW;

public class Btr80Renderer extends GeoEntityRenderer<Btr80Entity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, Btr80Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(Btr80Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, Btr80Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
